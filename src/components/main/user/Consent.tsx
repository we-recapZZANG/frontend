...
const Consent = () => {
  ...
  return (
    <div className="text-stone-600 h-screen text-sm flex flex-col gap-2 bg-white border-none rounded-lg p-3 ">
      ...
      <h3 className="mt-5 font-semibold  text-[15px] ">3. 보유 및 이용 기간</h3>
      회원 탈퇴 시까지
      <p>※ 단, 관계 법령에 따라 보존이 필요한 경우 해당 기간까지 보관</p>
      <p className="font-semibold">민감정보(음성 녹음) 수집에 대한 별도 동의</p>
      <p>
      ...
      <button
        className="w-[100px] bg-blue-100 px-2 py-2 rounded"
