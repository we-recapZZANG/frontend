...
const PlayAudioBook = ({ playAudioBookData }: PlayAudioBookProps) => {
  ...
  return (
    <div className="w-full flex justify-center flex-col h-[35%] px-10 bg-white border border-gray-100 rounded-b-2xl"
         style={{ boxShadow: '2px 3px 5px rgba(0, 0, 0, 0.05)', background: '#FFFFFF' }}>
      <div className="w-full h-[200px] flex flex-col gap-2 items-center bg-pink rounded-xl">
        ...
        <img src="/icon/rabbit.png" alt="story-category" width={90} height={90} />
        <div className="flex flex-row gap-4">
          <button onClick={handleRewind}>
            <img src="/icon/rewind.svg" alt="rewind" width={30} />
          </button>
          <button onClick={handlePlayPause}>
            <img src={isPlaying ? '/icon/pause.svg' : '/icon/play-audio.svg'} alt="play-pause" width={45} />
          </button>
